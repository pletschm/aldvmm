...
```{r plot-hist-obs, fig.cap = "Frequency distribution of observed EQ-5D-3L utilities", echo = FALSE}
...
knitr::kable(tab_sum_mod1bfgs$table,
             format = "simple",
             row.names = FALSE,
...
```{r plot-hist-pred, fig.cap = "Expected values from base case model", echo = FALSE}
...
```{r plot-comp-mhl-bfgs, fig.cap = "Mean residuals over deciles of expected values, \"BFGS\" with \"zero\" starting values", echo = FALSE}
...
As adjusted limited dependent variable mixture models are frequently used for tasks that rely on predictions, we also compare expected values from the "BFGS", "Nelder-Mead" and "hjn" methods to expected values from the "nlminb"  method. Expected values from the "Nelder-Mead" and "hjn" methods are smaller than "nlminb" values among observations with low and high expected values, while predictions from "BFGS" match predictions from the "nlminb" model fit closely (figure \@ref(fig:plot-comp-pred)).

```{r plot-comp-pred, fig.cap = "Deviation of expected values from \"BFGS\", \"Nelder-Mead\" and \"hjn\" versus \"nlminb\" with \"zero\" starting values", echo = FALSE}
...
knitr::kable(tab_sum_cstr$table,
             format = "simple",
             row.names = FALSE,
...
knitr::kable(tab_sum_tobit$table,
             format = "simple",
             row.names = FALSE,
...
knitr::kable(tab_sum_mod2$table,
             format = "simple",
             row.names = FALSE,
...
```{r box-pred-yhat-stata, fig.cap = "Fitted values in R and STATA", echo = FALSE}
knitr::include_graphics("plot_box_yhat.png")
```

<!-- ![(#fig:box-pred-yhat-stata) Fitted values in R and STATA](./plot_box_yhat.png) -->

```{r box-pred-se-stata, fig.cap = "Standard errors of fitted values in R and STATA", echo = FALSE}
...
## Example calculation of average treatment effects on the treated {- .unlisted .unnumbered}
...
\newpage
## Example calculation of robust and clustered standard errors {- .unlisted .unnumbered}
...
## Covariance matrices across optimization methods {- .unlisted .unnumbered}
...
## Modified Hosmer-Lemeshow test {- .unlisted .unnumbered}
...
## Results of modified Hosmer-Lemeshow test {- .unlisted .unnumbered}

```{r plot-comp-mhl-nm, fig.cap = "Mean residuals over deciles of expected values, \"Nelder-Mead\" with \"zero\" starting values", echo = FALSE}
...
```{r plot-comp-mhl-nlminb, fig.cap = "Mean residuals over deciles of expected values, \"nlminb\" with \"zero\" starting values", echo = FALSE}
...
```{r plot-comp-mhl-hjn, fig.cap = "Mean residuals over deciles of expected values, \"hjn\" with \"zero\" starting values", echo = FALSE}
...
\newpage
## R code for the estimation of reference cases {- .unlisted .unnumbered}
...
\newpage
## STATA\textsuperscript{\textregistered} code for the estimation of reference cases {- .unlisted .unnumbered}
