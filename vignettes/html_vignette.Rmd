...
n <- nrow(tab_sum_mod1bfgs$table)
tab_sum_mod1bfgs$table %>%
  kableExtra::kbl(row.names = FALSE,
      format = "html") %>%
  kableExtra::kable_styling() %>%
  kableExtra::row_spec(n, extra_css = "border-top: 1px solid grey; ") %>%
  kableExtra::row_spec(n, extra_css = "border-bottom-color: white; ") %>%
  kableExtra::row_spec(n, background = "#FFFFFF")

rm(tab_sum_mod1bfgs, n)
