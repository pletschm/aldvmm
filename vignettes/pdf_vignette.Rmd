...
author: Mark Pletscher^[Novartis Pharma AG, mark.pletscher@novartis.com]
date: "`r Sys.Date()`"
package: aldvmm
output:
...
rm(fit1_all, a, b, c, d, a.d, b.d, c.d, d.d, tmpdf, plot_comp_pred)
...
![(#fig:plot-hist-pred) Expected values from base case model](./plot_hist_pred.eps)
...
To validate the R implementation of adjusted limited dependent variable mixture models, we estimate the four models presented in @HernandezAlava2015 as reference cases in R and STATA\textsuperscript{\textregistered}.\footnote{The STATA\textsuperscript{\textregistered} and R code for model estimation is included in the [appendix](#rcode).}
...
## Example calculation of average treatment effects on the treated {- .unlisted .unnumbered #atetcode}
...
\newpage
## Example calculation of robust and clustered standard errors {- .unlisted .unnumbered #swcode}
...
## Covariance matrices across optimization methods {- .unlisted .unnumbered #covmat}
...
\newpage
## Modified Hosmer-Lemeshow test {- .unlisted .unnumbered #mhlcode}
...
\newpage
## Results of modified Hosmer-Lemeshow test {- .unlisted .unnumbered #mhlres}

![(#fig:plot-comp-mhl-nm) Mean residuals over deciles of expected values, "Nelder-Mead" with "zero" starting values](./plot_comp_mhl_nm.eps)

![(#fig:plot-comp-mhl-nlminb) Mean residuals over deciles of expected values, "nlminb" with "zero" starting values](./plot_comp_mhl_nlminb.eps)


![(#fig:plot-comp-mhl-hjn) Mean residuals over deciles of expected values, "hjn" with "zero" starting values](./plot_comp_mhl_hjn.eps)

\newpage
## R code for the estimation of reference cases {- .unlisted .unnumbered #rcode}
...
\newpage
## STATA\textsuperscript{\textregistered} code for the estimation of reference cases {- .unlisted .unnumbered #statacode}
...
\newpage
## ALDVMM likelihood and gradient functions {- .unlisted .unnumbered #likfun}
