...
```{r load_data, hide, eval = TRUE, echo = FALSE, results = 'hide'}
...
```{r calc_fit, hide, eval = FALSE, echo = FALSE, results = 'hide'}
...
```{r calc_plot, hide, eval = TRUE, echo = FALSE, results = 'hide'}
...
```{r calc_tab, hide, eval = TRUE, echo = FALSE, results = 'hide'}
...
STATA\textsuperscript{\textregistered}.
...
\newpage
## Detailed STATA\textsuperscript{\textregistered} results
...
print(xtable::xtable(tab_sum_stata3$table, 
                     align = "lllrrrrrr",
                     label = "tab:stata3",
                     caption = "Regression results from Hernandez Alava and Wailoo 2015, model 1 with user-defined initial values"),
      type = "latex",
      include.rownames = FALSE,
...
```{r tab-sum-stata4, echo = FALSE, results = "asis"}

load("tab_sum_stata4.RData")

print(xtable::xtable(tab_sum_stata4$table, 
                     align = "lllrrrrrr",
                     label = "tab:stata4",
                     caption = "Regression results from Hernandez Alava and Wailoo 2015, model 2 with user-defined initial values"),
      type = "latex",
      include.rownames = FALSE,
      hline.after = tab_sum_stata4$lindex,
      comment = FALSE,
      caption.placement = "top")
