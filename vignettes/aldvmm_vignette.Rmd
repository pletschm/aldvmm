...
```{r calc_tab_stata, hide, eval = TRUE, echo = FALSE, results = 'hide'}
...
The 'aldvmm' package can be installed from github using the function install_github() from the 'devtools' package.
...
```{r plot-comp-pred, echo = FALSE, results = "asis", fig.height = 2.9, fig.width = 6, fig.cap = 'Expected values from model 1, "Nelder-Mead" and "hjn" versus "nlminb" with zero starting values'}
...
names(stata_yhat_long) <- c("Reference case 1", "Reference case 2", "Reference case 3", "Reference case 4")
...
r_yhat_long <- rbind(cbind(variable = "Reference case 1",
                           value = fit1_nlminb[["pred"]][["yhat"]],
                           software = "R"),
                     cbind(variable = "Reference case 2",
                           value = fit1_cstr_stata[["pred"]][["yhat"]],
                           software = "R"),
                     cbind(variable = "Reference case 3",
                           value = fit1_cons[["pred"]][["yhat"]],
                           software = "R"),
                     cbind(variable = "Reference case 4",
...
names(stata_se_long) <- c("Reference case 1", "Reference case 2", "Reference case 3", "Reference case 4")
...
r_se_long <- rbind(cbind(variable = "Reference case 1",
