...
```{r load_data, eval = docalc, echo = FALSE, results = 'hide'}
...
```{r calc_fit, eval = docalc, echo = FALSE, results = 'hide'}
...
```{r calc_plot, eval = docalc, echo = FALSE, results = 'hide'}
...
```{r calc_tab, eval = docalc, echo = FALSE, results = 'hide'}
...
```{r calc_tab_stata, eval = docalc, echo = FALSE, results = 'hide'}
