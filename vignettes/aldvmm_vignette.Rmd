...
```{r load_data, eval = FALSE, echo = FALSE, results = 'hide'}
...
```{r calc_fit, eval = FALSE, echo = FALSE, results = 'hide'}
...
```{r calc_plot, eval = FALSE, echo = FALSE, results = 'hide'}
...
rm(i, hr, n1, mean1, sd1, n2, mean2, sd2, nsim, textout, plot_dens)
rm(fit1_all)
...
rm(plotdf, plot_box_yhat, r_yhat_long, stata_yhat_long)
...
suppressWarnings(
  plot_box_se <- ggplot(plotdf, aes(x = variable, y = as.numeric(value), fill = software)) +
    geom_boxplot() +
...
rm(plotdf, plot_box_se, r_se_long, stata_se_long)
rm(list = ls(pattern = "fit"))
...
```{r calc_tab, eval = FALSE, echo = FALSE, results = 'hide'}
...
rm(list = ls(pattern = "fit1"))
rm(list = ls(pattern = "fit2"))
rm(list = ls(pattern = "stata_"))
rm(list = ls(pattern = "tab_diff"))
rm(sumhat)
...
```{r calc_tab_stata, eval = FALSE, echo = FALSE, results = 'hide'}
...
suppressWarnings(plot_box_yhat)
