...
The parameter estimates and standard errors obtained in R are very similar to the results of the STATA\textsuperscript{\textregistered} package (table \@ref(tab:tab-comp-stata) and table \@ref(tab:tab-compse-stata)). The R package does not return any standard errors of reference model 2, while the STATA\textsuperscript{\textregistered} package returns standard errors for coefficients in component 1 and the multinomial logit. The values of the log-likelihood function in the optimum are consistently smaller in R than in STATA\textsuperscript{\textregistered} but the relative ordering of models is consistent across the two implementations. Overall, the comparison of the two implementations is not indicative of errors in the R implementation of adjusted limited dependent variable mixture models.
...
print(xtable::xtable(ymat, 
                     align = paste0("l", 
                                    paste(rep("r", ncol(ymat)), 
                                          collapse = "")),
                     label = "tab:compyhat",
                     caption = "Summary statistics of differences between R and STATA predictions of all observations in the estimation data",
                     digits = 6),
      type = "latex",
      include.rownames = TRUE,
...
print(xtable::xtable(semat, 
                     align = paste0("l", 
                                    paste(rep("r", ncol(semat)), 
                                          collapse = "")),
                     label = "tab:compse",
                     caption = "Summary statistics of differences between R and STATA standard errors of predictions of all observations in the estimation data",
                     digits = 6),
      type = "latex",
      include.rownames = TRUE,
