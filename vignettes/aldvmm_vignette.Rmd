...
To validate the R implementation of adjusted limited dependent variable mixture models, we compare the results of four reference models in R to the results of the same models in STATA\textsuperscript{\textregistered}.\footnote{The STATA\textsuperscript{\textregistered} and R code is included in the appendix.}
...
The parameter estimates and standard errors obtained in R are very similar to the results of the STATA\textsuperscript{\textregistered} package (table \@ref(tab:tab-comp-stata) and table \@ref(tab:tab-compse-stata)). The coefficient of the Oxford Hip Score in component 2 of model 2 differs between R and STATA\textsuperscript{\textregistered}, and the R package does not return standard errors of parameters. Although models 1 and 3 yield different parameter estimates, they converged at the same log-likelihood. This further supports the hypothesis of multiple local optima of the likelihood. The log-likelihood is consistently smaller in R than in STATA\textsuperscript{\textregistered}, but the relative ordering of models is consistent across the two implementations. Overall, the comparison of the two implementations is not indicative of errors in the R implementation of adjusted limited dependent variable mixture models.
...
print(xtable::xtable(ymat, 
                     align = paste0("l", 
                                    paste(rep("r", ncol(ymat)), 
                                          collapse = "")),
                     label = "tab:compyhat",
                     caption = "Summary statistics of differences between R and STATA predictions of all observations in the estimation data (positive values suggest larger values in STATA)",
                     digits = 6),
      type = "latex",
      include.rownames = TRUE,
...
print(xtable::xtable(semat, 
                     align = paste0("l", 
                                    paste(rep("r", ncol(semat)), 
                                          collapse = "")),
                     label = "tab:compse",
                     caption = "Summary statistics of differences between R and STATA standard errors of predictions of all observations in the estimation data (positive values suggest larger values in STATA)",
                     digits = 6),
      type = "latex",
      include.rownames = TRUE,
