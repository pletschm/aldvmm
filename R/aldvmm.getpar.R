...
#' 
#' @details \ifelse{html}{\code{\link[aldvmm]{aldvmm.getpar}}}{\code{aldvmm::aldvmm.getpar()}} identifies parameters that belong to coefficients of component distributions (label \code{"beta"}), coefficients of the multinomial logit model of probabilities of component membership (label \code{"delta"}), constant parameters of component distributions (label \code{"lnsigma"} for \code{dist=="normal"} and \code{1:K} components (labels "Comp1" ... "CompK")) based on parameter names generated by \ifelse{html}{\code{\link[aldvmm]{aldvmm.getnames}}}{\code{aldvmm::aldvmm.getnames()}}.
#'
#' @return a named nested list with parameter vectors for \code{"beta"}, \code{"delta"} and \code{"lnsigma"} within all \code{1:K} components. The names of the list correspond to the labels in \code{'lcoef'}, \code{'lcpar'} and \code{'lcmp'}.
#'
#' @export
